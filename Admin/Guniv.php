...
<?php
    ...
    text-align:center;
">
            <div style="width:50%;margin-left:auto;margin-right:auto;box-shadow:15px 15px 15px 15px black;margin-top:3%"
            >
        <div class="contenuimage"><td><img src="image3.php?id=<?php echo $user['id'];?>"  width="100"></td>
         <?php
         echo "<h1><span class='styleinfo'> Nom: </span>".$user['nomuniv']."<h1>";
         echo "<h1><span class='styleinfo'> Description: </span>".$user['descriptionuniv']."<h1>";
         echo "<h1><span class='styleinfo'> Localisation: </span>".$user['adresseuniv']."<h1>";
         echo "<h1><span class='styleinfo'> Adresse mail: </span>".$user['mailuniv']."<h1>";
         echo "<h1><span class='styleinfo'> Contact: </span>".$user['contactuniv']."<h1>";
         echo "<h1><span class='styleinfo'> Autorisation de publication: </span>".$user['validation']."<h1>";
         ?>
        </div> 
...
<form action="validationuniv.php" method="post">
...
<form action="supprimeruniv.php" method="post">
<input type="hidden" name="sup" value="<?php echo $user['id'] ?>">
