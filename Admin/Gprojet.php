<?php
    ...
    $req=$con->prepare("SELECT * FROM standmention ");
$req->execute();
$users = $req->fetch();
    $req->execute(Array());
?>
...
<?php
      while($user=$req->fetch()) {
        ...
        <div class="contenuimage"><td><img src="imagemention.php?id=<?php echo $user['id'];?>"  width="100"></td>
         <?php
         echo "<h1><span class='styleinfo'> Mention: </span>".$user['mentionstand']."<h1>";
          echo "<h1><span class='styleinfo'> Projet: </span>".$user['projet']."<h1>";
          echo "<h1><span class='styleinfo'> Description du projet: </span>".$user['descriprojet']."<h1>";
          echo "<h1><span class='styleinfo'> Auteur du: </span>".$user['auteur']."<h1>";
         echo "<h1>Autorisation: ".$user['validation']."<h1>";
         ?>
        </div> 
...
<td><img   src="imagestand.php?id=<?php echo $user['id'];?>"  width="350"></td>
<form action="validerprojet.php" method="post">
...
<form action="supprimerprojet.php" method="post">
