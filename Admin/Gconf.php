<?php
    ...
    $req=$con->prepare("SELECT * FROM conference ");
$req->execute();
$users = $req->fetch();
    $req->execute(Array());
?>
...
<?php
      while($user=$req->fetch()) {
        ...
        <div class="contenuimage"><td><img src="imageconf2.php?id=<?php echo $user['id'];?>"  width="100"></td>
         <?php
         echo "<h1><span class='styleinfo'> Mention: </span>".$user['mention']."<h1>";
          echo "<h1><span class='styleinfo'> Thème: </span>".$user['theme']."<h1>";
          echo "<h1><span class='styleinfo'> Résumer du projet: </span>".$user['resume']."<h1>";
          echo "<h1><span class='styleinfo'> Date: </span>".$user['date']."<h1>";
         echo "<h1><span class='styleinfo'>Heure: </span>".$user['heure']."<h1>";
         echo "<h1><span class='styleinfo'>Lieu: </span>".$user['lieu']."<h1>";
         echo "<h1><span class='styleinfo'>Présenter par: </span>".$user['presentateur']."<h1>";
         echo "<h1><span class='styleinfo'>Autorisation de publier: </span>".$user['validation']."<h1>";
         ?>
        </div> 
...
<td><img   src="imageconf.php?id=<?php echo $user['id'];?>"  width="350"></td>
